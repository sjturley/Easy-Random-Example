...
public class PersonTest {
    ...
    public void generatePerson() {
        EasyRandomParameters parameters = new EasyRandomParameters()
                ...
                .randomize(FieldPredicates.named("firstName").or(FieldPredicates.named("middleName")), new FirstNameRandomizer())
                .randomize(FieldPredicates.named("lastName"), new LastNameRandomizer())
                .randomize(FieldPredicates.named("ssn"), ssnRandomizer)
                .randomize(FieldPredicates.named("postalCode"), new ZipCodeRandomizer())
                .randomize(FieldPredicates.named("city"), new CityRandomizer())
                .randomize(FieldPredicates.named("county"), new CityRandomizer())
                ...
                .randomize(FieldPredicates.named("latitude"), new LatitudeRandomizer())
                .randomize(FieldPredicates.named("longitude"), new LongitudeRandomizer())
